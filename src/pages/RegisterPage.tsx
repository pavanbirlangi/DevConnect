            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <CardContent className="space-y-4">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <Link to="/terms" className="text-devconnect-purple hover:underline">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link to="/privacy" className="text-devconnect-purple hover:underline">
                    Privacy Policy
                  </Link>
                  .
                </div>
              ...
              <CardFooter className="flex justify-center">
                <p className="text-sm text-center text-muted-foreground">
                  ...
                  <Link to="/login" className="text-devconnect-purple hover:underline">
                    Login
                  </Link>
                </p>
              </CardFooter>
